...
private:
    ...
    static const DWORD NUM_STREAMS = 2;
    bool _wasStreamPreviouslySelected[NUM_STREAMS]; // maybe makes more sense as a property of the stream
    ComPtr<SimpleMediaStream> _videoStream, _depthStream;
    ComPtr<SimpleMediaStream> _streams[NUM_STREAMS];
};
